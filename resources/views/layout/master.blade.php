...
<head>
    ...
    <title>Hasy Store - Dashboard</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-black sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: black;">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Hasy<sup>Store</sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/admin">
                    ...
                    <span class="{{$title=='dashboard'?'text-white' : ''}}">Kategori </span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span class="{{$title=='dashboard'?'text-white' : ''}}">Halaman Utama</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/admin/jenis">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span class="{{$title=='dashboard'?'text-white' : ''}}">Jenis</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/admin/iklan">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span class="{{$title=='dashboard'?'text-white' : ''}}">iklan</span>
                </a>
            </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; abib 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
