        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/admin">
                    ...
                    <span class="{{$title=='dashboard'?'text-gray-900' : ''}}">Kategori </span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span class="{{$title=='dashboard'?'text-gray-900' : ''}}">Halaman Utama</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/admin/jenis">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span class="{{$title=='dashboard'?'text-gray-900' : ''}}">Jenis</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/admin/iklan">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span class="{{$title=='dashboard'?'text-gray-900' : ''}}">iklan</span>
                </a>
            </li>
